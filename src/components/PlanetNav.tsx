  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Special styling for Saturn - tilted ring band */}
          {item.planet === 'Saturn' && (
            <>
              <div
                className="absolute"
                style={{
                  ...
                  background: `linear-gradient(90deg, rgba(250, 213, 165, ${isHovered ? 0.9 : 0.6}), rgba(250, 213, 165, ${isHovered ? 0.5 : 0.3}), rgba(250, 213, 165, ${isHovered ? 0.9 : 0.6}))`,
                  borderRadius: '50%',
                  ...
                  boxShadow: isHovered ? '0 0 8px rgba(250, 213, 165, 0.6)' : 'none',
                }}
              />
              <div
                className="absolute"
                style={{
                  ...
                  left: '50%',
                  transform: 'translate(-50%, -50%) rotate(20deg)',
                  border: `1px solid rgba(250, 213, 165, ${isHovered ? 0.7 : 0.4})`,
                  borderRadius: '50%',
